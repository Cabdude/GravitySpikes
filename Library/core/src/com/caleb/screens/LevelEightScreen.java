...
public class LevelEightScreen implements Screen {

	private GravitySpikesRevamped game;
	private OrthogonalTiledMapRenderer renderer;
	private OrthographicCamera gamecam;
	private TiledMap levelEight;
	...
	public LevelEightScreen(GravitySpikesRevamped game) {
		this.game = game;
		...
		levelEight = new TmxMapLoader().load("LevelEight.tmx");
		renderer = new OrthogonalTiledMapRenderer(levelEight, 1 / GravitySpikesRevamped.PPM);
		...
		new B2WorldCreator(world, levelEight);
	...
	public void handleInput(float dt) {
		...
		if (ExitPortal.win == GravitySpikesRevamped.EXIT_BIT) {
			...
			new PreferenceManager().addPreferences("Eight");
		}
	}
