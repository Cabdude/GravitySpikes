...
public class LevelFiveScreen implements Screen {

	private GravitySpikesRevamped game;
	private OrthogonalTiledMapRenderer renderer;
	private OrthographicCamera gamecam;
	private TiledMap levelFive;
	...
	public LevelFiveScreen(GravitySpikesRevamped game) {
		this.game = game;
		...
		levelFive = new TmxMapLoader().load("LevelFive.tmx");
		renderer = new OrthogonalTiledMapRenderer(levelFive, 1 / GravitySpikesRevamped.PPM);
		...
		new B2WorldCreator(world, levelFive);
	...
	public void handleInput(float dt) {
		...
		if (ExitPortal.win == GravitySpikesRevamped.EXIT_BIT) {
			...
			new PreferenceManager().addPreferences("Five");
		}
	}
