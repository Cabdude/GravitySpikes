...
public class LevelFourScreen implements Screen {

	private GravitySpikesRevamped game;
	private OrthogonalTiledMapRenderer renderer;
	private OrthographicCamera gamecam;
	private TiledMap levelFour;
	...
	public LevelFourScreen(GravitySpikesRevamped game) {
		this.game = game;
		...
		levelFour = new TmxMapLoader().load("LevelFour.tmx");
		renderer = new OrthogonalTiledMapRenderer(levelFour, 1 / GravitySpikesRevamped.PPM);
		...
		new B2WorldCreator(world, levelFour);
	...
	public void handleInput(float dt) {
		...
		if (ExitPortal.win == GravitySpikesRevamped.EXIT_BIT) {
			...
			new PreferenceManager().addPreferences("Four");
		}
	}
