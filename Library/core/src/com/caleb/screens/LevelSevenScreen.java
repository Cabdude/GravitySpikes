...
public class LevelSevenScreen implements Screen {

	private GravitySpikesRevamped game;
	private OrthogonalTiledMapRenderer renderer;
	private OrthographicCamera gamecam;
	private TiledMap levelSeven;
	...
	public LevelSevenScreen(GravitySpikesRevamped game) {
		this.game = game;
		...
		levelSeven = new TmxMapLoader().load("LevelSeven.tmx");
		renderer = new OrthogonalTiledMapRenderer(levelSeven, 1 / GravitySpikesRevamped.PPM);
		...
		new B2WorldCreator(world, levelSeven);
	...
	public void handleInput(float dt) {
		...
		if (ExitPortal.win == GravitySpikesRevamped.EXIT_BIT) {
			...
			new PreferenceManager().addPreferences("Seven");
		}
	}
