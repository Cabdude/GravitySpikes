...
public class LevelThreeScreen implements Screen {
	...
	public LevelThreeScreen(GravitySpikesRevamped game) {
		this.game = game;
		...
		levelThree = new TmxMapLoader().load("LevelThree.tmx");
		renderer = new OrthogonalTiledMapRenderer(levelThree, 1 / GravitySpikesRevamped.PPM);
		...
		new B2WorldCreator(world, levelThree);
	...
	public void handleInput(float dt) {
		...
		if (ExitPortal.win == GravitySpikesRevamped.EXIT_BIT) {
			...
			new PreferenceManager().addPreferences("Three");
		}
	}
