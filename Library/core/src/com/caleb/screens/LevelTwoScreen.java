...
public class LevelTwoScreen implements Screen {
	...
	public LevelTwoScreen(GravitySpikesRevamped game) {
		this.game = game;
		...
		levelTwo = new TmxMapLoader().load("LevelTwo.tmx");
		renderer = new OrthogonalTiledMapRenderer(levelTwo, 1 / GravitySpikesRevamped.PPM);
		...
		new B2WorldCreator(world, levelTwo);
	...
	public void handleInput(float dt) {
		...
		if (ExitPortal.win == GravitySpikesRevamped.EXIT_BIT) {
			...
			new PreferenceManager().addPreferences("Two");
		}
	}
