...
public class MainMenuScreen implements Screen {
	...
	private static final int PLAY_Y = 50;
	...
	public void render(float delta) {
		...
		game.batch.draw(menuTitle,(GravitySpikesRevamped.GAME_WIDTH/2 - PLAY_WIDTH / 2) / GravitySpikesRevamped.PPM, TITLE_Y / GravitySpikesRevamped.PPM,
